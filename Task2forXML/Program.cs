...
namespace XMLWriterReader
{
    ...
    class MyXML
    {
        ...
        public static Order XMLLoad(string path, Order ord)
        {
            ...
            {
                ord._products.Add(new Product(xel.GetAttribute("name"), xel.GetElementsByTagName("description")[0].InnerText,Int32.Parse(xel.GetElementsByTagName("price")[0].InnerText)));
